...
[**Territories of Exception**](https://documental.xyz/intervencao). Documental.xyz, 2021. Coordination, authorship, data analysis and visualization. Also published in [Portuguese](https://documental.xyz/pt/intervencao) and [Spanish](https://documental.xyz/es/intervencao). 🌐
...
[**Economias subversivas**](https://imotiro.org/livros/economias-subversivas-livro/) (book organization), Editora Imotirõ, 2017.

[**Tecnomagia**](https://imotiro.org/livros/tecnomagia-2/) (book organization). Editora Imotirõ, 2016.

[**Copyfight: pirataria e cultura livre**](https://midiatatica.desarquivo.org/2010-2013/copyfight/) (book organization and chapter authorship). 2012.

**Ponha-se Na Rua** (coauthorship). Editora Luminatti, 2008.

## Published chapters

**Espectro e vigilância** (authorship). In: Tecnopolíticas da vigilância: perspectivas da margem. Editora Boitempo. 2018.

**Espectro e Vigilância** (authorship). In: Rádios Comunitárias em Tempos Digitais. AMARC Brasil. 2017.

**Tecnoxamanismo - Antropofagia da técnica** (authorship). In: [Tecnoxamanismo](https://tecnoxamanismo.files.wordpress.com/2018/05/tcnxmnm-22_layout-2.pdf). 2016.

**Submidialogias** (co-authorship). In: Ideias Perigozas: submidialogias. Editora Córrego, 2011.

[**As culturas digitais dos Pontos de Cultura e Lan houses**](https://editora.fgv.br/produto/pontos-de-cultura-e-lan-houses-estruturas-para-inovacao-na-base-da-piramide-social-2452) (co-authorship). In: Pontos de Cultura e Lan houses: estruturas para inovação na base da pirâmide social. Editora Fundação Getúlio Vargas. 2011.

**Comunicação Comunitária: Contexto e Produção em Núcleos de Estudo do Rio de Janeiro** (co-authorship). In: [Comunidade e Contra-hegemonia: Rotas de Comunicação Alternativa](https://mauad.com.br/comunidade-e-contra-hegemonia-rotas-de-comunicacao-alternativa). Editora Mauad. 2008.
